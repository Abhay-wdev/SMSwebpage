...
const FloatingContact = () => {
  ...
  const ActionButton = ({ onClick, icon, label, bgColor }) => (
    <div className="group relative">
      ...
      <span className="absolute left-16 md:left-20 top-1/2 -translate-y-1/2 bg-gray-800 text-white px-3 md:px-4 py-1.5 md:py-2 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300 text-sm md:text-base font-medium whitespace-nowrap shadow-lg">
        {label}
      </span>
    </div>
  );
