...
const GoogleBusinessServices = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Expert Google Business Profile Management Services | SEOcial Media Solutions</title>
        <meta
          name="description"
        ...
        <meta property="og:image" content="https://yourwebsite.com/images/og-gbp.jpg" />
        <meta property="og:url" content="https://yourwebsite.com/google-business-profile" />
