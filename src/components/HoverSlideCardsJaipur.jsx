        ...
        {cards.map((card, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-end p-6 transition-opacity duration-500 ${
...
export default HoverSlideCardsJaipur;
