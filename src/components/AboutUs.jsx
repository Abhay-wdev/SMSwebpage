...
const faqs = [
  {
    question: "Why is SEOcial Media Solutions considered the best digital marketing agency in Jaipur?",
  ...
  {
    question: "Can SEOcial Media Solutions manage my social media platforms completely?",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://seocialmedia.in/digital-marketing-company-jaipur" />
        <meta property="og:title" content="Best Digital Marketing Agency in Jaipur | SEOcial Media Solutions" />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600">Everything you need to know about our digital marketing services</p>
              </div>
