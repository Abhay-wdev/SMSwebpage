...
const services = [
  {
    ...
    description:
      "Our graphic design services in  Jaipur are crafted to visually represent your business identity with impact and clarity. From unique color schemes to personalized branding elements, we ensure that your brand connects with the local audience while maintaining global appeal. Our team blends tradition with modern aesthetics to design creatives that reflect  Jaipur's cultural richness and your business vision.",
