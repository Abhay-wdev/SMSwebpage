  ...
  if (error || !blog) {
    return (
      <div className="min-h-screen bg-[#F5F7F5] flex flex-col justify-center items-center px-4">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">{error || 'Blog post not found'}</h1>
        <p className="text-gray-600 mb-6">The blog post you're looking for might have been moved or deleted.</p>
        <Link to="/blog" className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-md transition-colors">
          Back to Blog
        </Link>
      </div>
    );
